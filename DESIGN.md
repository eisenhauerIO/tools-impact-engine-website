...
| `memos.html` | Card grid listing available memos |
| `memos/*.html` | Individual memo pages — topic-first articles using Impact Engine as the running example |
...
3. Memos reference component behavior and link to relevant documentation

## Future directions

- **Memo vault build-out**: Write 5-6 memos covering validation, config design, uncertainty propagation, and other cross-cutting topics before starting social media distribution
- **Social media slicing**: Extract key insights, code snippets, and diagrams from memos for LinkedIn/Twitter posts, linking back to the canonical long-form source
